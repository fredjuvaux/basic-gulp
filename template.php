...
/**
 * Add span for customization
 */
function basic_checkbox($variables)
{
  $element = $variables['element'];
 ...
 * Add span for customization
 */
function basic_radio($variables)
{
  $element = $variables['element'];
 ...
 * Remove size attr
 */
function basic_password($variables)
{
  $element = $variables ['element'];
 ...
 * Remove size attr
 */
function basic_textfield($variables)
{
  $element = $variables['element'];
 ...
 * Remove size attr
 */
function basic_textarea($variables)
{
  $element = $variables ['element'];
  element_set_attributes($element, array('id', 'name', 'rows'));
